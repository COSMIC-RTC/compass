...
void init_smatrix_from_larger_smatrix(kp_smatrix<real>&M_to, const kp_smatrix<real>&M_from, const int indr1, const int indc1, const int indr2, const int indc2);
