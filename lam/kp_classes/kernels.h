...
// mat += A1 (avec A1, diagonale par bloc : A1=[Atur Btur ; eye(nb_az) zeros(nb_az)] avec Atur (resp. Btur), matrice diagonale de dimension nb_az dont la diagonale est le vecteur atur (resp. btur))
