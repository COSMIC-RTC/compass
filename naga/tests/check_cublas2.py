...
Vectx = obj_Float1D(c, dims=shx)
Vectx.random(time.clock())

shy = np.array([sizem], dtype=np.int64)
Vecty = obj_Float1D(c, dims=shy)
Vecty.random(time.clock())

Vectx2 = obj_Float1D(c, dims=shy)
