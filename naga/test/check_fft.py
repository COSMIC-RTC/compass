...
def test_fft_C2C():
    ...
    C1=ch.naga_obj_ComplexD2D(c,dims=np.array((m,n)))
    C1.random(time.clock()*10**6)
    C2=ch.naga_obj_ComplexD2D(c,dims=np.array((m,n)))
...
def test_fft_R2C_C2R():
    ...
    #generating random carma_obj
    R1=ch.naga_obj_Double2D(c,dims=np.array((m,n)))
...
def Ntest_fft_multi():
    ...
    C1=ch.naga_obj_ComplexD3D(c,dims=np.array((m,n,l)))
    C2=ch.naga_obj_ComplexD3D(c,dims=np.array((m,n,l)))
    C3=ch.naga_obj_ComplexD3D(c,dims=np.array((m,n,l)))
