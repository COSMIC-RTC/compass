...
template<class T_data>
carma_obj<T_data>::carma_obj(carma_context *current_context,  carma_obj<T_data> *src){
  /** \brief carma_obj creator.
   * \param src : carma_obj to copy
   */
...
template<class T_data>
carma_obj<T_data>::carma_obj(carma_context *current_context, long *dims_data, T_data *data){
  /** \brief carma_obj creator.
   * \param dims_data : the array size Yorick format : [ndims,dims1,dims2,...]
...
template caObjS::carma_obj(carma_context *current_context, long *dims_data, float *data);
template caObjD::carma_obj(carma_context *current_context, long *dims_data, double *data);
template caObjI::carma_obj(carma_context *current_context, long *dims_data, int *data);
template caObjUI::carma_obj(carma_context *current_context, long *dims_data, unsigned int *data);
template caObjS2::carma_obj(carma_context *current_context, long *dims_data, float2 *data);
template caObjD2::carma_obj(carma_context *current_context, long *dims_data, double2 *data);

template<class T_data>
carma_obj<T_data>::carma_obj(carma_context *current_context, long *dims_data, int nb_streams){
  /** \brief carma_obj creator.
   * \param dims_data : the array size Yorick format : [ndims,dims1,dims2,...]
   */
...
template caObjS::carma_obj(carma_context *current_context, long *dims_data, int nb_streams);
template caObjD::carma_obj(carma_context *current_context, long *dims_data, int nb_streams);
template caObjI::carma_obj(carma_context *current_context, long *dims_data, int nb_streams);
template caObjUI::carma_obj(carma_context *current_context, long *dims_data, int nb_streams);
template caObjS2::carma_obj(carma_context *current_context, long *dims_data, int nb_streams);
template caObjD2::carma_obj(carma_context *current_context, long *dims_data, int nb_streams);

template<class T_data>
carma_obj<T_data>::carma_obj(carma_context *current_context, long *dims_data, T_data *data, int nb_streams){
  /** \brief carma_obj creator.
   * \param dims_data : the array size Yorick format : [ndims,dims1,dims2,...]
   * \param data : the array
   */
...
template caObjS::carma_obj(carma_context *current_context, long *dims_data, float *data, int nb_streams);
template caObjD::carma_obj(carma_context *current_context, long *dims_data, double *data, int nb_streams);
template caObjI::carma_obj(carma_context *current_context, long *dims_data, int *data, int nb_streams);
template caObjUI::carma_obj(carma_context *current_context, long *dims_data, unsigned int *data, int nb_streams);
template caObjS2::carma_obj(carma_context *current_context, long *dims_data, float2 *data, int nb_streams);
template caObjD2::carma_obj(carma_context *current_context, long *dims_data, double2 *data, int nb_streams);

template<class T_data>
void carma_obj<T_data>::init(carma_context *context, long *dims_data, T_data *data, bool fromHost, int nb_streams){
...
template<class T_data> carma_obj<T_data>::~carma_obj( ){
...
template cudaStream_t caObjS::get_cudaStream_t(int stream);
...
template int caObjS::wait_all_streams();
