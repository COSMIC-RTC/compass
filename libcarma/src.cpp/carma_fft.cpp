...
template<>
cufftResult fft_compute<cuFloatComplex, cuFloatComplex>(cufftHandle plan,
...
cufftResult fft_compute<cufftReal, cuFloatComplex>(cufftHandle plan,
    cufftReal *d_input, cuFloatComplex *d_output, int dir) {
...
template<>
cufftResult fft_compute<cuDoubleComplex, cuDoubleComplex>(cufftHandle plan,
    cuDoubleComplex *d_input, cuDoubleComplex *d_output, int dir) {
  return cufftExecZ2Z(plan, d_input, d_output, dir);
}

template<>
cufftResult fft_compute<cufftDoubleReal, cuDoubleComplex>(cufftHandle plan,
    cufftDoubleReal *d_input, cuDoubleComplex *d_output, int dir) {
  return cufftExecD2Z(plan, d_input, d_output);
}

template<>
cufftResult fft_compute<cuDoubleComplex, cufftDoubleReal>(cufftHandle plan,
