...
template int carma_fft<cuFloatComplex, cufftReal>(cuFloatComplex *input,
		cufftReal *output, int dir, cufftHandle plan);
...
template int carma_fft<cuFloatComplex, cuFloatComplex>(cuFloatComplex *input,
		cuFloatComplex *output, int dir, cufftHandle plan);
template int carma_fft<cufftDoubleReal, cufftDoubleReal>(cufftDoubleReal *input,
		cufftDoubleReal *output, int dir, cufftHandle plan);
template int carma_fft<cufftDoubleReal, cuDoubleComplex>(cufftDoubleReal *input,
		cuDoubleComplex *output, int dir, cufftHandle plan);
template int carma_fft<cuDoubleComplex, cufftDoubleReal>(cuDoubleComplex *input,
		cufftDoubleReal *output, int dir, cufftHandle plan);
template int carma_fft<cuDoubleComplex, cuDoubleComplex>(cuDoubleComplex *input,
		cuDoubleComplex *output, int dir, cufftHandle plan);
