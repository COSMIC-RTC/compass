...
template carma_host_obj<unsigned int>::carma_host_obj(
    carma_host_obj<unsigned int> *src);
...
template carma_host_obj<int>::carma_host_obj(carma_host_obj<int> *src,
    MemAlloc mallocType);
template carma_host_obj<unsigned int>::carma_host_obj(
    carma_host_obj<unsigned int> *src, MemAlloc mallocType);
template carma_host_obj<cuFloatComplex>::carma_host_obj(
...
template carma_host_obj<int>::carma_host_obj(carma_host_obj<int> *src,
    int nb_streams);
template carma_host_obj<unsigned int>::carma_host_obj(
    carma_host_obj<unsigned int> *src, int nb_streams);
template carma_host_obj<cuFloatComplex>::carma_host_obj(
...
template carma_host_obj<int>::carma_host_obj(carma_host_obj<int> *src,
    MemAlloc mallocType, int nb_streams);
template carma_host_obj<unsigned int>::carma_host_obj(
    carma_host_obj<unsigned int> *src, MemAlloc mallocType, int nb_streams);
template carma_host_obj<cuFloatComplex>::carma_host_obj(
...
template<class T_data>
void carma_host_obj<T_data>::init(long *dims_data, T_data *data,
    MemAlloc mallocType, int nb_streams) {
  ...
  if (mallocType == MA_MALLOC) {
    ...
    cutilSafeCall(
        cudaHostRegister(h_data, sizeof(T_data) * this->nb_elem,
