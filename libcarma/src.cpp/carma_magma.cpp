...
magma_int_t lda = N; lapackf77_dlacpy(MagmaUpperLowerStr, &N, &N, *mat, &lda, *U, &lda); return carma_syevd_m_gen(magma_dsyevd_m, ngpu, magma_vec_const(jobz), N, U->getData(), eigenvals->getData()));
}
