...
template <class T_data, int32_t (*ksparse_bsrmv)(
                            int32_t matrix_dim, int32_t block_dim, T_data alpha,
                            T_data* A, int32_t* bsr_row_ptr, int32_t* bsr_col_ind,
                            const T_data* __restrict x, T_data beta, T_data* y)>
int32_t carma_kgemv_gen(int32_t matrix_dim, int32_t block_dim, T_data alpha, T_data* A,
                    int32_t* bsr_row_ptr, int32_t* bsr_col_ind,
                    const T_data* __restrict x, T_data beta, T_data* y) {
...
template <>
int32_t carma_kgemv<float>(CarmaSparseObj<float>* A, float alpha,
...
template <>
int32_t carma_kgemv<double>(CarmaSparseObj<double>* A, double alpha,
