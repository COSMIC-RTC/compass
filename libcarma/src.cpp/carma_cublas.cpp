...
cublasStatus_t
carma_checkCublasStatus_v2(cublasStatus_t status, int line, string file)
...
cublasStatus_t
carma_initCublas(cublasHandle_t *cublas_handle)
...
cublasStatus_t
carma_shutdownCublas(cublasHandle_t cublas_handle)
...
cublasOperation_t
carma_char2cublasOperation(char operation) {
  switch (operation) {
  case 't':
    return CUBLAS_OP_T;
  case 'c':
...
template<>
  int
  carma_wheremax<float>(cublasHandle_t cublas_handle, int n, float *vect,
      int incx) {
    int result = 0;
...
template<>
  int
  carma_wheremax<double>(cublasHandle_t cublas_handle, int n, double *vect,
      int incx) {
    int result = 0;
...
template<>
  int
  carma_wheremin<float>(cublasHandle_t cublas_handle, int n, float *vect,
      int incx) {
    int result = 0;
...
template<>
  int
  carma_wheremin<double>(cublasHandle_t cublas_handle, int n, double *vect,
      int incx) {
    int result = 0;
...
template<>
  float
  carma_getasum<float>(cublasHandle_t cublas_handle, int n, float *vect,
      int incx) {
    float result = 0;
...
template<>
  double
  carma_getasum<double>(cublasHandle_t cublas_handle, int n, double *vect,
      int incx) {
    double result = 0;
...
template<>
  cublasStatus_t
  carma_axpy<float>(cublasHandle_t cublas_handle, int n, float alpha,
...
template<>
  cublasStatus_t
  carma_axpy<double>(cublasHandle_t cublas_handle, int n, double alpha,
...
template<>
  cublasStatus_t
  carma_copy<float>(cublasHandle_t cublas_handle, int n, float *vectx, int incx,
      float *vecty, int incy) {
    return carma_checkCublasStatus(cublasScopy(cublas_handle,n, vectx,incx,vecty,incy));
  }
template<>
  cublasStatus_t
  carma_copy<double>(cublasHandle_t cublas_handle, int n, double *vectx,
...
template<>
  float
  carma_dot<float>(cublasHandle_t cublas_handle, int n, float *vectx, int incx,
      float *vecty, int incy) {
    float result = 0;
...
template<>
  double
  carma_dot<double>(cublasHandle_t cublas_handle, int n, double *vectx,
      int incx, double *vecty, int incy) {
    double result = 0;
    carma_checkCublasStatus(
...
template<>
  float
  carma_nrm2<float>(cublasHandle_t cublas_handle, int n, float *vect,
      int incx) {
    float result = 0;
...
template<>
  double
  carma_nrm2<double>(cublasHandle_t cublas_handle, int n, double *vect,
      int incx) {
    double result = 0;
...
template<>
  cublasStatus_t
  carma_rot<float>(cublasHandle_t cublas_handle, int n, float *vectx, int incx,
      float *vecty, int incy, float sc, float ss) {
    return carma_checkCublasStatus(cublasSrot(cublas_handle,n,vectx,incx,vecty,incy,&sc,&ss));
  }
template<>
  cublasStatus_t
  carma_rot<double>(cublasHandle_t cublas_handle, int n, double *vectx,
      int incx, double *vecty, int incy, double sc, double ss) {
...
template<>
  cublasStatus_t
  carma_scal<float>(cublasHandle_t cublas_handle, int n, float alpha,
      float *vectx, int incx) {
    return carma_checkCublasStatus(cublasSscal(cublas_handle,n,&alpha,vectx,incx));
  }
template<>
  cublasStatus_t
  carma_scal<double>(cublasHandle_t cublas_handle, int n, double alpha,
      double *vectx, int incx) {
...
template<>
  cublasStatus_t
  carma_swap<float>(cublasHandle_t cublas_handle, int n, float *vectx, int incx,
      float *vecty, int incy) {
    return carma_checkCublasStatus(cublasSswap(cublas_handle,n,vectx,incx,vecty,incy));
  }
template<>
  cublasStatus_t
  carma_swap<double>(cublasHandle_t cublas_handle, int n, double *vectx,
      int incx, double *vecty, int incy) {
...
template<>
  cublasStatus_t
  carma_gemv<float>(cublasHandle_t cublas_handle, char trans, int m, int n,
      float alpha, float *matA, int lda, float *vectx, int incx, float beta,
      float *vecty, int incy) {
...
template<>
  cublasStatus_t
  carma_gemv<double>(cublasHandle_t cublas_handle, char trans, int m, int n,
      double alpha, double *matA, int lda, double *vectx, int incx, double beta,
...
template<>
  cublasStatus_t
  carma_ger<float>(cublasHandle_t cublas_handle, int m, int n, float alpha,
      float *vectx, int incx, float *vecty, int incy, float *matA, int lda) {
    return carma_checkCublasStatus(cublasSger(cublas_handle,m,n,&alpha,vectx,incx,vecty,incy,matA,lda));
  }
template<>
  cublasStatus_t
  carma_ger<double>(cublasHandle_t cublas_handle, int m, int n, double alpha,
      double *vectx, int incx, double *vecty, int incy, double *matA, int lda) {
...
template<>
  cublasStatus_t
  carma_symv<float>(cublasHandle_t cublas_handle, cublasFillMode_t uplo, int n,
      float alpha, float *matA, int lda, float *vectx, int incx, float beta,
      float *vecty, int incy) {
...
template<>
  cublasStatus_t
  carma_symv<double>(cublasHandle_t cublas_handle, cublasFillMode_t uplo, int n,
      double alpha, double *matA, int lda, double *vectx, int incx, double beta,
      double *vecty, int incy) {
...
template<>
  cublasStatus_t
  carma_gemm<float>(cublasHandle_t cublas_handle, char transa, char transb,
      int m, int n, int k, float alpha, float *matA, int lda, float *matB,
      int ldb, float beta, float *matC, int ldc) {
...
template<>
  cublasStatus_t
  carma_gemm<double>(cublasHandle_t cublas_handle, char transa, char transb,
      int m, int n, int k, double alpha, double *matA, int lda, double *matB,
      int ldb, double beta, double *matC, int ldc) {
    cublasOperation_t transa2 = carma_char2cublasOperation(transa);
    cublasOperation_t transb2 = carma_char2cublasOperation(transb);
...
template<>
  cublasStatus_t
  carma_symm<float>(cublasHandle_t cublas_handle, cublasSideMode_t side,
      cublasFillMode_t uplo, int m, int n, float alpha, float *matA, int lda,
...
template<>
  cublasStatus_t
  carma_symm<double>(cublasHandle_t cublas_handle, cublasSideMode_t side,
      cublasFillMode_t uplo, int m, int n, double alpha, double *matA, int lda,
...
template<>
  cublasStatus_t
  carma_syrk<float>(cublasHandle_t cublas_handle, cublasFillMode_t uplo,
      char transa, int n, int k, float alpha, float *matA, int lda, float beta,
      float *matC, int ldc) {
    cublasOperation_t transa2 = carma_char2cublasOperation(transa);
...
template<>
  cublasStatus_t
  carma_syrk<double>(cublasHandle_t cublas_handle, cublasFillMode_t uplo,
      char transa, int n, int k, double alpha, double *matA, int lda,
...
template<>
  cublasStatus_t
  carma_syrkx<float>(cublasHandle_t cublas_handle, cublasFillMode_t uplo,
      char transa, int n, int k, float alpha, float *matA, int lda, float *matB,
      int ldb, float beta, float *matC, int ldc) {
    cublasOperation_t transa2 = carma_char2cublasOperation(transa);
...
template<>
  cublasStatus_t
  carma_syrkx<double>(cublasHandle_t cublas_handle, cublasFillMode_t uplo,
      char transa, int n, int k, double alpha, double *matA, int lda,
      double *matB, int ldb, double beta, double *matC, int ldc) {
    cublasOperation_t transa2 = carma_char2cublasOperation(transa);
...
template<class T_data>
  ...
  carma_geam(cublasHandle_t cublas_handle, char transa, char transb, int m,
      int n, T_data alpha, T_data *matA, int lda, T_data beta, T_data *matB,
      int ldb, T_data *matC, int ldc);
/**< Generic template for geam executable selection */
template<>
  cublasStatus_t
  carma_geam<float>(cublasHandle_t cublas_handle, char transa, char transb,
      int m, int n, float alpha, float *matA, int lda, float beta, float *matB,
...
template<>
  cublasStatus_t
  carma_geam<double>(cublasHandle_t cublas_handle, char transa, char transb,
      int m, int n, double alpha, double *matA, int lda, double beta,
...
template<>
  cublasStatus_t
  carma_dgmm<float>(cublasHandle_t cublas_handle, cublasSideMode_t side, int m,
      int n, float *matA, int lda, float *vectx, int incx, float *matC,
      int ldc) {
    return carma_checkCublasStatus(cublasSdgmm(cublas_handle,side,m,n,matA,lda,vectx,incx,matC,ldc));
  }
template<>
  cublasStatus_t
  carma_dgmm<double>(cublasHandle_t cublas_handle, cublasSideMode_t side, int m,
      int n, double *matA, int lda, double *vectx, int incx, double *matC,
      int ldc) {
...
template<class T_data>
  int
  carma_obj<T_data>::host2deviceVect(T_data *data, int incx, int incy) {
...
template<class T_data>
  int
  carma_obj<T_data>::device2hostVect(T_data *data, int incx, int incy) {
...
template<class T_data>
  int
  carma_obj<T_data>::host2deviceMat(T_data *data, int lda, int ldb) {
...
template<class T_data>
  int
  carma_obj<T_data>::device2hostMat(T_data *data, int lda, int ldb) {
...
template<class T_data>
  int
  carma_obj<T_data>::imax(int incx) {
    /** \brief imax method
     * \param incx : increment in x
     *
...
template<class T_data>
  int
  carma_obj<T_data>::imin(int incx) {
    /** \brief imin method
     * \param incx : increment in x
     *
...
template<class T_data>
  T_data
  carma_obj<T_data>::asum(int incx) {
    /** \brief asum method
     * \param incx : increment in x
     *
...
template<class T_data>
  T_data
  carma_obj<T_data>::nrm2(int incx) {
...
template<class T_data>
  void
  carma_obj<T_data>::scale(T_data alpha, int incx) {
...
template<class T_data>
  void
  carma_obj<T_data>::copy(carma_obj<T_data> *source, int incx, int incy) {
    ...
    carma_copy(current_context->get_cublasHandle(), this->nb_elem,
...
template<class T_data>
  void
  carma_obj<T_data>::swap(carma_obj<T_data> *source, int incx, int incy) {
    ...
    carma_swap(current_context->get_cublasHandle(), this->nb_elem,
        source->d_data, incx, this->d_data, incy);
  }
template void
...
template<class T_data>
  void
  carma_obj<T_data>::axpy(T_data alpha, carma_obj<T_data> *source, int incx,
      int incy) {
...
template<class T_data>
  T_data
  carma_obj<T_data>::dot(carma_obj<T_data> *source, int incx, int incy) {
...
template<class T_data>
  void
  carma_obj<T_data>::rot(carma_obj<T_data> *source, int incx, int incy,
      T_data sc, T_data ss) {
     ...
     * this method computes the dot product of two vectors
     */
    carma_rot(current_context->get_cublasHandle(), this->nb_elem,
        source->d_data, incx, this->d_data, incy, sc, ss);
  }
template void
...
template<class T_data>
  void
  carma_obj<T_data>::gemv(char trans, T_data alpha, carma_obj<T_data> *matA,
...
template<class T_data>
  void
  carma_obj<T_data>::ger(T_data alpha, carma_obj<T_data> *vectx, int incx,
...
template<class T_data>
  void
  carma_obj<T_data>::symv(cublasFillMode_t uplo, T_data alpha,
...
template<class T_data>
  void
  carma_obj<T_data>::gemm(char transa, char transb, T_data alpha,
...
template<class T_data>
  void
  carma_obj<T_data>::symm(cublasSideMode_t side, cublasFillMode_t uplo,
...
template<class T_data>
  void
  carma_obj<T_data>::syrk(cublasFillMode_t uplo, char transa, T_data alpha,
...
template<class T_data>
  void
  carma_obj<T_data>::syrkx(cublasFillMode_t uplo, char transa, T_data alpha,
      carma_obj<T_data> *matA, int lda, carma_obj<T_data> *matB, int ldb,
      T_data beta, int ldc) {
...
template<class T_data>
  void
  carma_obj<T_data>::geam(char transa, char transb, T_data alpha,
...
template<class T_data>
  void
  carma_obj<T_data>::dgmm(cublasSideMode_t side, carma_obj<T_data> *matA,
