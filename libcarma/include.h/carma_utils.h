...
namespace carma_utils {
  ...
  void inline split(std::vector<std::string> &tokens, const std::string &text, char sep) {
...
inline void __carmafftSafeCall(cufftResult err, const char *file, const int line) {
