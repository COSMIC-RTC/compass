...
template<class T_data> class carma_host_obj;
...
template<class T> int fillarray2d2(T *d_odata, T *d_idata, int x0, int Ncol,
		int NC, int N);
template<class T> int fill_sym_matrix(char src_uplo, T *d_data, int Ncol,
		int N);
...
template<class T> int carma_syevd(char jobz, carma_obj<T> *mat,
		carma_host_obj<T> *eigenvals);
template<class T, int method> int carma_syevd(char jobz, carma_obj<T> *mat,
		carma_host_obj<T> *eigenvals);
template<class T> int carma_syevd_m(long ngpu, char jobz,
		carma_host_obj<T> *mat, carma_host_obj<T> *eigenvals,
		carma_host_obj<T> *U);
template<class T> int carma_getri(carma_obj<T> *d_iA);
template<class T> int carma_potri(carma_obj<T> *d_iA);
template<class T> int carma_potri_m(long num_gpus, carma_host_obj<T> *h_A,
		carma_obj<T> *d_iA);

// MAGMA functions (direct access)
template<class T> int carma_syevd(char jobz, long N, T *mat, T *eigenvals);
