...
template<class T_data> cublasStatus_t carma_symm(cublasHandle_t cublas_handle,
		...
		T_data alpha, T_data *matA, int lda, T_data *matB, int ldb, T_data beta,
		T_data *matC, int ldc);
...
template<class T_data> cublasStatus_t carma_geam(cublasHandle_t cublas_handle,
		char transa, char transb, int m, int n, T_data alpha, T_data *matA,
		int lda, T_data beta, T_data *matB, int ldb, T_data *matC, int ldc);

template<class T_data> cublasStatus_t carma_dgmm(cublasHandle_t cublas_handle,
		cublasSideMode_t side, int m, int n, T_data *matA, int lda,
		T_data *vectx, int incx, T_data *matC, int ldc);
