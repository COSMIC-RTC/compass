...
extern "C" void padKernel3d(
    ...
    assert(d_Src != d_Dst);
    dim3 threads(16, 8, 8);
    dim3 grid(iDivUp(kernelW, threads.x), iDivUp(kernelH, threads.y),iDivUp(nim, threads.z));
...
extern "C" void padDataClampToBorder3d(
    ...
    assert(d_Src != d_Dst);
    dim3 threads(16, 8, 8);
    dim3 grid(iDivUp(fftW, threads.x), iDivUp(fftH, threads.y), iDivUp(nim, threads.z));
