    ...
    - [Install MAGMA](#install-magma)
        ...
        - [Configure MAGMA & installation (expert way)](#configure-magma-installation-expert-way)
            - [Using OpenBlas](#using-openblas)
                - [Dependencies : openblas (<http://www.openblas.net>)](#dependencies-openblas-httpwwwopenblasnet)
                - [Configure MAGMA using the local build of OpenBLAS](#configure-magma-using-the-local-build-of-openblas)
            - [Using MKL](#using-mkl)
