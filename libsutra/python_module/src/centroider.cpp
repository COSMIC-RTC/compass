...
void centroider_impl(py::module &mod, const char *name) {
    ...
    py::class_<centroider>(mod, name)
        ...
        .def_property_readonly(
            "context", [](centroider &sc) { return sc.current_context; },
            "GPU context")

        .def_property_readonly(
            "device", [](centroider &sc) { return sc.device; },
            "GPU device index")

        .def_property_readonly(
            "type", [](centroider &sc) { return sc.get_type(); },
            "Centroider type")

        .def_property_readonly(
            "nslopes", [](centroider &sc) { return sc.nslopes; },
            "Number of slopes")

        .def_property_readonly(
            "wfs", [](centroider &sc) { return sc.wfs; },
            "sutra_wfs handled by this centroider")

        .def_property_readonly(
            "nvalid", [](centroider &sc) { return sc.nvalid; },
            "Number of valid ssp of the WFS")

        .def_property_readonly(
            "nxsub", [](centroider &sc) { return sc.nxsub; },
            "Number of ssp across the pupil diameter")

        .def_property_readonly(
            "npix", [](centroider &sc) { return sc.npix; },
            "Number of pixels along a side of WFS subap.")

        .def_property_readonly(
            "offset", [](centroider &sc) { return sc.offset; },
            "Offset for centroiding computation")

        .def_property_readonly(
            "scale", [](centroider &sc) { return sc.scale; },
        ...
        .def_property_readonly(
            "d_bincube", [](centroider &sc) { return sc.d_bincube; },
            "Bincube of the WFS image")

        .def_property_readonly(
            "d_intensities", [](centroider &sc) { return sc.d_intensities; },
            "intensities of the WFS image")

        .def_property_readonly(
            "d_centroids_ref", [](centroider &sc) { return sc.d_centroids_ref; },
            "Reference slopes vector")

        .def_property_readonly(
            "d_img", [](centroider &sc) { return sc.d_img; },
            "Calibrated WFS image")

        .def_property_readonly(
            "d_img_raw", [](centroider &sc) { return sc.d_img_raw; },
            "Raw WFS image")

        .def_property_readonly(
            "d_validx", [](centroider &sc) { return sc.d_validx; },
            "X positions of the valid ssp")

        .def_property_readonly(
            "d_validy", [](centroider &sc) { return sc.d_validy; },
            "Y positions of the valid ssp")

        .def_property_readonly(
            "d_dark", [](centroider &sc) { return sc.d_dark; },
            "Dark frame for calibration")

        .def_property_readonly(
            "d_flat", [](centroider &sc) { return sc.d_flat; },
            "Flat frame for calibration")

        .def_property_readonly(
            "d_lutPix", [](centroider &sc) { return sc.d_lutPix; },
        ...
        .def_property_readonly(
            "filter_TT", [](centroider &sc) { return sc.filter_TT; },
            "Tip/tilt filtering flag")

        .def_property_readonly(
            "d_ref_Tip", [](centroider &sc) { return sc.d_ref_Tip; },
            "Tip mode reference for filtering")

        .def_property_readonly(
            "d_ref_Tilt", [](centroider &sc) { return sc.d_ref_Tilt; },
            "Tilt mode reference for filtering")

        .def_property_readonly(
            "d_TT_slopes", [](centroider &sc) { return sc.d_TT_slopes; },
