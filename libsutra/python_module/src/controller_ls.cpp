...
void controller_ls_impl(py::module &mod, const char *name) {
  ...
  py::class_<controller_ls, sutra_controller<Tcomp, Tout>>(mod, name)
      ...
      .def_property_readonly("d_cmat",
                             [](controller_ls &sc) { return sc.d_cmat; },
                             "Control matrix")

      .def_property_readonly("d_gain",
                             [](controller_ls &sc) { return sc.d_gain; },
                             "vector of modal gains")

      .def_property_readonly("d_eigenvals",
                             [](controller_ls &sc) { return sc.d_eigenvals; },
                             "Eigen values of the imat")

      .def_property_readonly("d_U", [](controller_ls &sc) { return sc.d_U; },
                             "Eigen modes of the imat")

      .def_property_readonly("d_cenbuff",
                             [](controller_ls &sc) { return sc.d_cenbuff; },
                             "Centroids circular buffer")

      .def_property_readonly("d_err",
                             [](controller_ls &sc) { return sc.d_err; },
                             "Current increment on the command")

      .def_property_readonly("is_modopti",
                             [](controller_ls &sc) { return sc.is_modopti; },
