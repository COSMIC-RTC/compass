...
class sutra_telemetry {
 ...
 public:
  ...
  get_nbObjs();
  int
  add_obj(type_telemetry_pair obj, carma_host_obj<float> *host_obj);
  int
  add_obj(std::string type_obj, int num_obj, carma_host_obj<float> *host_obj);
  int
  del_obj(type_telemetry_pair obj);
  int
  del_obj(std::string type_obj, int num_obj);
  int
  del_all_objs();
  carma_host_obj<float>*
  get_carma_host_obj(type_telemetry_pair obj);
  carma_host_obj<float>*
  get_carma_host_obj(std::string type_obj, int num_obj);
  ...
  /**< Memory transfer */
  int
  fill_from(std::string type_obj, int num_obj, float *data);
  int
  fill_into(std::string type_obj, int num_obj, float *data);
