...
class sutra_telemetry {
 ...
 public:
  sutra_telemetry();
  sutra_telemetry(type_telemetry_pair obj,carma_host_obj<float> *host_obj, unsigned int nbStreams);
  sutra_telemetry(std::string type_obj,int num_obj,carma_host_obj<float> *host_obj, unsigned int nbStreams);
  ...
  int add_obj(std::string type_obj,int num_obj, carma_host_obj<float> *host_obj);
  ...
  int cpy_obj(std::string type_obj,int num_obj, carma_obj<float> *d_obj, cudaMemcpyKind flag);
