...
class sutra_tscreen {
 ...
 public:
  sutra_tscreen(carma_context *context, long size, long size2, float amplitude, float altitude, 
...
class sutra_atmos {
 ...
 public:
  sutra_atmos(carma_context *context, int nscreens,float *r0,long *size, long *size2, 
