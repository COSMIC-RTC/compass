...
public:
	sutra_tscreen(carma_context *context, long size, long size2,
			float amplitude, float altitude, float windspeed, float winddir,
...
public:
	...
	int init_screen(float alt, float *h_A, float *h_B,
