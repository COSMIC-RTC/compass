...
string
sutra_centroider_pyr::get_type() {
  return "pyr";
}

int
sutra_centroider_pyr::init_bincube(sutra_wfs *wfs) {

  return EXIT_SUCCESS;
}

int
sutra_centroider_pyr::get_cog(carma_streams *streams, float *cube,
...
int
sutra_centroider_pyr::get_pyr(float *cube, float *subsum, float *centroids,
...
int
sutra_centroider_pyr::get_cog(sutra_wfs *wfs, float *slopes) {
...
int
sutra_centroider_pyr::get_cog(sutra_wfs *wfs) {
