...
int
sutra_telemetry::get_nbObjs() {
  return this->objs.size();
}

int
sutra_telemetry::get_nbStreams() {
  return this->streams->get_nbStreams();
}

int
sutra_telemetry::add_stream() {
  this->streams->add_stream();
  return this->streams->get_nbStreams();
}

int
sutra_telemetry::add_stream(int nb) {
  this->streams->add_stream(nb);
  return this->streams->get_nbStreams();
}

int
sutra_telemetry::del_stream() {
  this->streams->del_stream();
  return this->streams->get_nbStreams();
}

int
sutra_telemetry::del_stream(int nb) {
  this->streams->del_stream(nb);
  return this->streams->get_nbStreams();
}

int
sutra_telemetry::del_all_streams() {
  this->streams->del_all_streams();
  return this->streams->get_nbStreams();
}

int
sutra_telemetry::add_obj(type_telemetry_pair obj,
...
int
sutra_telemetry::add_obj(std::string type_obj, int num_obj,
    carma_host_obj<float> *host_obj) {
...
int
sutra_telemetry::del_obj(type_telemetry_pair obj) {
...
int
sutra_telemetry::del_obj(std::string type_obj, int num_obj) {
...
int
sutra_telemetry::cpy_obj(std::string type_obj, int num_obj,
...
/**< Memory transfer */
int
sutra_telemetry::fill_from(std::string type_obj, int num_obj, float *data) {
  this->objs[make_pair(type_obj, num_obj)]->fill_from(data);
  return EXIT_SUCCESS;
}

int
sutra_telemetry::fill_into(std::string type_obj, int num_obj, float *data) {
  this->objs[make_pair(type_obj, num_obj)]->fill_into(data);
  return EXIT_SUCCESS;
}

int
sutra_telemetry::wait_obj(std::string type_obj, int num_obj) {
  this->objs[make_pair(type_obj, num_obj)]->wait_all_streams();
  return EXIT_SUCCESS;
}

cudaStream_t
sutra_telemetry::get_cudaStream_t(int stream) {
  return this->streams->get_stream(stream);
}

int
sutra_telemetry::wait_stream(int stream) {
  this->streams->wait_stream(stream);
  return EXIT_SUCCESS;
}

int
sutra_telemetry::wait_all_streams() {
