...
sutra_centroider::sutra_centroider(carma_context *context, long nwfs, long nvalid, float offset, float scale, int device,const char *typec)
{
  this->d_bincube  = 0L;
  this->d_subsum  = 0L;
  this->d_refcentro = 0L;
...
int sutra_centroider::init_bincube(sutra_wfs *wfs)
{
  if (this->d_bincube != 0L) delete this->d_bincube;
...
int sutra_centroider::init_weights(sutra_wfs *wfs)
{
  if (this->d_weights != 0L) delete this->d_weights;
...
int sutra_centroider::set_threshold(float threshold)
{
...
int sutra_centroider::set_nmax(int nmax)
{
  this->nmax = nmax;
...
int sutra_centroider::load_weights(float *weights, int ndim)
{
...
int sutra_centroider::init_corr(sutra_wfs *wfs, int isizex, int isizey, float *interpmat)
{
  current_context->set_activeDevice(device);
  if (this->d_corrfnct != 0L) delete this->d_corrfnct;
  if (this->d_corrspot != 0L) delete this->d_corrspot;
...
int sutra_centroider::load_corr(float *corr, float *corr_norm, int ndim)
{
  ...
  carma_fft(this->d_corrfnct->getData(),this->d_corrfnct->getData(),1,*this->d_corrfnct->getPlan());

  return EXIT_SUCCESS;
}

int sutra_centroider::get_cog(float *cube,float *subsum, float *centroids, int nvalid, int npix, int ntot)
{
  // simple cog
...
int sutra_centroider::get_cog(sutra_wfs *wfs, carma_obj<float> *slopes)
{
  return this->get_cog(wfs->d_bincube->getData(),wfs->d_subsum->getData(),slopes->getData(),
		       wfs->nvalid,wfs->npix,wfs->d_bincube->getNbElem());
}

int sutra_centroider::get_cog(sutra_wfs *wfs)
{
  return this->get_cog(wfs,wfs->d_slopes);
}

int sutra_centroider::get_cog_async(carma_streams *streams, float *cube,float *subsum, float *centroids, int nvalid, int npix)
{
  // simple cog
...
int sutra_centroider::get_cog_async(sutra_wfs *wfs, carma_obj<float> *slopes)
{
  return this->get_cog_async(wfs->streams,wfs->d_bincube->getData(),wfs->d_subsum->getData(),slopes->getData(),
		       wfs->nvalid,wfs->npix);
}

int sutra_centroider::get_cog_async(sutra_wfs *wfs)
{
  return this->get_cog_async(wfs,wfs->d_slopes);
}

int sutra_centroider::get_tcog(float threshold,float *cube,float *subsum, float *centroids, int nvalid, int npix, int ntot)
{
  // thresholded cog
...
int sutra_centroider::get_bpcog(int nmax, int npix, int nvalid, float *cube, float *centroids)
{
...
int sutra_centroider::get_wcog(float *weights,float *cube,float *subsum,float *centroids, int nvalid, int npix, int ntot)
{
  // wcog
...
int sutra_centroider::get_tcog(float threshold,sutra_wfs *wfs, float *slopes)
{
...
int sutra_centroider::get_tcog(float threshold,sutra_wfs *wfs)
{
  return this->get_tcog(threshold,wfs,wfs->d_slopes->getData());
}

int sutra_centroider::get_bpcog(int nmax,sutra_wfs *wfs, float *slopes)
{
  return this->get_bpcog(nmax,wfs->npix,wfs->nvalid,wfs->d_bincube->getData(),slopes);
}

int sutra_centroider::get_bpcog(int nmax,sutra_wfs *wfs)
{
  return this->get_bpcog(nmax,wfs,wfs->d_slopes->getData());
}

int sutra_centroider::get_wcog(sutra_wfs *wfs, float *slopes)
{
  return this->get_wcog(this->d_weights->getData(),wfs->d_bincube->getData(),wfs->d_subsum->getData(),
		 slopes,wfs->nvalid,wfs->npix,wfs->d_bincube->getNbElem());
}

int sutra_centroider::get_wcog(sutra_wfs *wfs)
{
  return this->get_wcog(wfs,wfs->d_slopes->getData());
}

int sutra_centroider::get_corr(sutra_wfs *wfs, float *slopes)
{
  //set corrspot to 0
  ...
  carma_fft(this->d_corrspot->getData(),this->d_corrspot->getData(),1,*this->d_corrfnct->getPlan());
...
int sutra_centroider::get_corr(sutra_wfs *wfs)
{
...
// deprecated
int sutra_centroider::init_nmax(int nmax)
{
  if (this->d_validpix != 0L) delete this->d_validpix;
  if (this->d_validindx!= 0L)  delete  this->d_validindx;
  ...
  this->d_validpix = new carma_obj<float>(current_context,dims_data2);
  this->d_validindx = new carma_obj<int>(current_context,dims_data2);
...
int sutra_centroider::get_pyr(float *cube,float *subsum, float *centroids, int *subindx, int *subindy, int nvalid, int ns, int nim)
{
  // simple cog
...
int sutra_centroider::get_pyr(sutra_wfs *wfs, carma_obj<float> *slopes)
{
...
int sutra_centroider::get_pyr(sutra_wfs *wfs)
{
