...
sutra_centroider_roof::sutra_centroider_roof(carma_context *context,
...
string sutra_centroider_roof::get_type() { return "roof"; }
...
int sutra_centroider_roof::get_cog(float *subsum, float *slopes, bool noise) {
  return this->get_roof(*(wfs->d_bincube), subsum, slopes, *(wfs->d_validsubsx),
