...
sutra_controller_generic::sutra_controller_generic(carma_context *context, long nvalid, long nactu,
	...
	long dims_data2[3] = {2,nactu,2*nvalid};
...
sutra_controller_generic::comp_com() {
	current_context->set_activeDevice(device,1);
  fprintf(stderr, "sutra_controller_generic::comp_com\n");
	...
	// g*CMAT*s(k)
	mult_vect(this->d_compbuff->getData(),
			this->d_gain->getData(), -1.0f, this->nactu(),
