...
template <class Tin, class T>
int sutra_centroider_maskedPix<Tin, T>::get_selected_pix(T *pix) {
  this->current_context->set_activeDevice(this->device, 1);

  const long *dims_data2 = this->d_img->getDims();
  ...
  pyr_selected_pix(this->d_selected_pix->getData(), dims_data2[1], pix,
