...
sutra_dm::sutra_dm(carma_context *context, const char* type, long dim, long ninflu, long influsize, long ninflupos, long n_npoints, float push4imat, int device)
{
...
int sutra_dm::pzt_loadarrays(float *influ, int *influpos,int *npoints, int *istart, int *xoff, int *yoff)
{
...
int sutra_dm::kl_loadarrays(float *rabas, float *azbas,int *ord, float *cr, float *cp)
{
...
int sutra_dms::add_dm(carma_context *context, const char* type,float alt, long dim, long ninflu, long influsize, long ninflupos, long n_npoints, float push4imat, int device)
{
  this->d_dms[make_pair(type,alt)] = new sutra_dm(context, type,dim,ninflu,influsize,ninflupos,n_npoints,push4imat,device);
