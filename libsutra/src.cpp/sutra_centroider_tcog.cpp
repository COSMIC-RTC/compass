...
int sutra_centroider_tcog::get_cog(float *cube, float *intensities,
  ...
  subap_reduce_new(ntot, npix * npix, nvalid, cube, intensities,
                   this->threshold, this->current_context->get_device(device));

  get_centroids(ntot, npix * npix, nvalid, npix, cube, centroids, intensities,
                this->threshold, this->scale, this->offset,
                this->current_context->get_device(device));
#else
  subap_reduce(ntot, npix * npix, nvalid, cube, intensities, this->threshold,
               this->current_context->get_device(device));
