...
func check_syevd_host(n, compare_yorick=)
{
  if(is_void(compare_yorick)) compare_yorick=0;
...
func check_syevd_double(n, compare_yorick=)
{
  if(is_void(compare_yorick)) compare_yorick=0;
...
func check_syevd_m_double(n, ngpu, compare_yorick=)
{
  if(is_void(ngpu)) ngpu=1;
  if(is_void(compare_yorick)) compare_yorick=0;
