    ...
    for i in range(-10,n):
        ...
        if(config.p_controllers[0].type_control == "geo"):
            ...
            #compute the error breakdown for this iteration
                error_breakdown(com,noise_com,alias_wfs_com,tomo_com,H_com,trunc_com,bp_com,wf_com,mod_com,fit,i)
...
###################################################################################
def error_breakdown(com,noise_com,alias_wfs_com,tomo_com,H_com,trunc_com,bp_com,wf_com,mod_com,fit,i):
    """
