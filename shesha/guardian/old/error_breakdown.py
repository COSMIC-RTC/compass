...
def save_it(filename):
    ...
    pdict = {
            ...
            "bandwidth": bp_com.T, "wf_com": wf_com.T, "P": P, "Btt": Btt,
            "IF.data": IF.data, "IF.indices": IF.indices, "IF.indptr": IF.indptr,
            "dm_dim": dm_dim, "indx_pup": indx_pup, "fitting": fit, "SR": SR, "SR2": SR2,
