...
psf_compass = rexp.get_psf(filename)
SR = []
EE5 = []
EE10 = []
EE20 = []
...
for s in tqdm(speed):
    ...
    SR.append(psfi.max())
    EE5.append(rexp.ensquared_energy(filename, psfi, 5))
    EE10.append(rexp.ensquared_energy(filename, psfi, 10))
    EE20.append(rexp.ensquared_energy(filename, psfi, 20))

plt.figure()
plt.plot(speed, psf_compass.max() - SR)
plt.figure()
plt.plot(speed, rexp.ensquared_energy(filename, psf_compass, 5) - EE5)
plt.plot(speed, rexp.ensquared_energy(filename, psf_compass, 10) - EE10)
plt.plot(speed, rexp.ensquared_energy(filename, psf_compass, 20) - EE20)
