...
p_loop.set_ittime(1 / 3000.0)  # =1/500
...
p_wfs0.set_nxsub(
    240  # 100 to get 95 pixels in the pupil.
...
p_wfs0.set_pyr_pup_sep(125)  # half pupil separation (center-to-center)
...
# p_dm0.set_nact(nact)
p_dm0.set_nact(200)  # 75 actuators on 40m for a projected M4 pitch of 54.05 cm
p_dm0.set_alt(0.0)
