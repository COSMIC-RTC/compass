...
p_atmos.set_winddir([0.0, 10.0, 20.0, 25.0, 0.0, 10.0, 20.0, 25.0, 0.0, 10.0])
p_atmos.set_L0([25.0, 25.0, 25.0, 25.0, 25.0, 25.0, 25.0, 25.0, 25.0, 25.0])
...
for p_wfs in p_wfs_lgs:
    ...
    p_wfs.set_lgsreturnperwatt(22.0)
...
p_controller1.set_maxcond(15000.0)
p_controller1.set_delay(1.0)
