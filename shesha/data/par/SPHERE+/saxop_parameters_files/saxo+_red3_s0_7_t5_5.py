...
freq_second_stage = 1250. # /?\ Setup here second stage frequency
...
p_loop.set_niter(6376)                  # number of loops will be overwritten by SAXO [?]
p_loop.set_ittime(0.0008) # /!\ second stage frequency to be set above [?]
...
p_wfs0.set_gsmag(14.3)            # Not used.
...
p_dm0.set_file_influ_fits(dm_data + 'Boston28x28_flat.fits') # /!\ choice made at the begin. of this file
...
p_controller0.set_delay(0.375) # /?\ needs to be refined [?]
