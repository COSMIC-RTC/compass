...
# p_tel.set_std_tt(0.025) # microns
# p_tel.set_std_piston(0.03535) # microns
# p_tel.set_referr(0.026)
...
r0 = atmosPar.r0med
alt = atmosPar.altESO
frac = atmosPar.fracmed
# wind = np.array(atmosPar.windESO) * 2.
...
p_targets[1].set_xpos(0.0)
p_targets[1].set_ypos(0.0)
p_targets[1].set_Lambda(1.65)
p_targets[1].set_mag(4.0)
p_targets[2].set_xpos(0.0)
p_targets[2].set_ypos(0.0)
p_targets[2].set_Lambda(2.2)
p_targets[2].set_mag(4.0)

rMod = 5  # Modulation radius, in lam/D units
