...
p_atmos.set_frac([0.5, 0.5])
p_atmos.set_alt([4999.9, 5000.0])
p_atmos.set_windspeed([15.0, 15.0])
p_atmos.set_winddir([0, -90])
p_atmos.set_L0([100, 100])
p_atmos.set_seeds([1234, 1235])
...
for i in range(len(p_wfss)):
    ...
    p_wfss[i].set_xpos(-4.0)
    p_wfss[i].set_ypos(-4.0)
    p_wfss[i].set_Lambda(0.5)
    p_wfss[i].set_gsmag(6.0)
