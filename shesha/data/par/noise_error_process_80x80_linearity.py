...
simul_name = "errorProcess_Micado"
#loop
...
for i in range(len(p_wfss)):
    ...
    p_wfss[i].set_xpos(0.)
    p_wfss[i].set_ypos(0.)
    p_wfss[i].set_Lambda(0.6)
    p_wfss[i].set_gsmag(10.)
    p_wfss[i].set_optthroughput(0.537)
    p_wfss[i].set_zerop(4.07e13)
