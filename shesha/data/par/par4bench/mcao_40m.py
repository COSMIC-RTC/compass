...
p_wfs1.set_xpos(40.0)
p_wfs1.set_ypos(40.0)
p_wfs1.set_Lambda(0.5)
p_wfs1.set_gsmag(8.0)
p_wfs1.set_optthroughput(0.5)
p_wfs1.set_zerop(1.0e11)
p_wfs1.set_noise(1.0)
...
p_wfs2.set_xpos(40.0)
p_wfs2.set_ypos(-40.0)
p_wfs2.set_Lambda(0.5)
p_wfs2.set_gsmag(8.0)
p_wfs2.set_optthroughput(0.5)
p_wfs2.set_zerop(1.0e11)
p_wfs2.set_noise(1.0)
...
p_wfs3.set_xpos(-40.0)
p_wfs3.set_ypos(40.0)
p_wfs3.set_Lambda(0.5)
p_wfs3.set_gsmag(8.0)
p_wfs3.set_optthroughput(0.5)
p_wfs3.set_zerop(1.0e11)
p_wfs3.set_noise(1.0)
...
p_wfs4.set_xpos(-40.0)
p_wfs4.set_ypos(-40.0)
p_wfs4.set_Lambda(0.5)
p_wfs4.set_gsmag(8.0)
p_wfs4.set_optthroughput(0.5)
p_wfs4.set_zerop(1.0e11)
p_wfs4.set_noise(1.0)
