...
class widgetTwoStagesWindowPyro:
    ...
    def loop_once(self) -> None:
        ...
        for wao in [self.wao1, self.wao2]:
            ...
            refreshDisplayTime = 1.0 / wao.uiBase.wao_frameRate.value()
            ...
            if time.time() - wao.refreshTime > refreshDisplayTime:
                ...
                for t in range(len(wao.config.p_targets)):
                    ...
                    # TODO: handle that !
                    if t == wao.uiAO.wao_dispSR_tar.value():  # Plot on the wfs selected
                        wao.updateSRDisplay(SR[1], SR[0], wao.supervisor.get_frame_counter())
                    signal_se += "%1.2f   " % SR[0]
                    signal_le += "%1.2f   " % SR[1]
    ...
    def set_pyr_tools_params(self, ai):
        ...
        if self.phase_to_modes is None:
            ...
            self.phase_to_modes = self.manager.second_stage.basis.compute_phase_to_modes(
                self.modal_basis
            )
    ...
    def start_pyro_server(self):
        try:
            ...
            devices1 = [
                ...
                supervisor1.tel,
                supervisor1.basis,
                supervisor1.calibration,
                supervisor1.atmos,
                supervisor1.dms,
                supervisor1.config,
                supervisor1.modalgains,
                coro2pyro1,
            ]
            devices2 = [
                supervisor2,
                ...
                supervisor2.tel,
                supervisor2.basis,
                supervisor2.calibration,
                supervisor2.atmos,
                supervisor2.dms,
                supervisor2.config,
                supervisor2.modalgains,
                coro2pyro2,
            ]
            names = [
                "supervisor",
            ...
            nname.append(
                "twoStagesManager" + "_" + user
            )  # Adding master next dedicated to trigger 2-stages loop
...
if __name__ == "__main__":
    ...
    wao = widgetTwoStagesWindowPyro(
        arguments["<parameters_filename1>"],
