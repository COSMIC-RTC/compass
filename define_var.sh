...
export COMPASS_ROOT=$(pwd)
export YOGA_DIR=$COMPASS_ROOT/yoga
export YOGA_AO_DIR=$COMPASS_ROOT/yoga_ao
...
export YORICK_PATH=$YORICK_ROOT
...
echo "export CUDA_INC_PATH=$CUDA_INC_PATH"
echo "export CUDA_LIB_PATH=$CUDA_LIB_PATH"
echo "export CUDA_LIB_PATH_64=$CUDA_LIB_PATH_64"
...
echo "export YOGA_AO_DIR=$YOGA_AO_DIR"
echo "export YOGA_AO_TOP=$YOGA_AO_TOP"
echo
