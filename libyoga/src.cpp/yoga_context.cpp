...
int yoga_context::set_activeDeviceForCpy(int newDevice, int silent){
...
int yoga_context::set_activeDevice(int newDevice, int silent){
...
string yoga_context::get_activeDeviceStr(){
	cudaDeviceProp deviceProp;
...
int yoga_context::get_maxGflopsDeviceId()
