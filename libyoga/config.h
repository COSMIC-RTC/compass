...
/* Define to 1 if you have the `cudpp_x86_64' library (-lcudpp_x86_64). */
/* #undef HAVE_LIBCUDPP_X86_64 */

/* Define to 1 if you have the `cufft' library (-lcufft). */
/* #undef HAVE_LIBCUFFT */

/* Define to 1 if you have the `cula_core' library (-lcula_core). */
/* #undef HAVE_LIBCULA_CORE */

/* Define to 1 if you have the `cula_lapack' library (-lcula_lapack). */
/* #undef HAVE_LIBCULA_LAPACK */

/* Define to 1 if you have the `curand' library (-lcurand). */
/* #undef HAVE_LIBCURAND */

/* Define to 1 if you have the `lapack' library (-llapack). */
#define HAVE_LIBLAPACK 1

/* Define to 1 if you have the `magma' library (-lmagma). */
/* #undef HAVE_LIBMAGMA */

/* Define to 1 if you have the `magmablas' library (-lmagmablas). */
/* #undef HAVE_LIBMAGMABLAS */
