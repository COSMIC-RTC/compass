...
def test_gemm():
    ...
    matA=ch.chakra_obj_Float2D(c,dims=np.array([sizem,sizek],dtype=np.int64))
    matB=ch.chakra_obj_Float2D(c,dims=np.array([sizek,sizen],dtype=np.int64))
    matC=ch.chakra_obj_Float2D(c,dims=np.array([sizem,sizen],dtype=np.int64))
...
def test_symm():
    ...
    matA=ch.chakra_obj_Float2D(c,dims=np.array([sizek,sizek],dtype=np.int64))
    matB=ch.chakra_obj_Float2D(c,dims=np.array([sizek,sizen],dtype=np.int64))
    matC=ch.chakra_obj_Float2D(c,dims=np.array([sizek,sizen],dtype=np.int64))
...
def test_dgmm():
    ...
    # C,A matrices, d vector (diagonal matrix as a vector)
     ...
     #generating random matrices and associated carma_obj
    matA=ch.chakra_obj_Float2D(c,dims=np.array([sizek,sizek],dtype=np.int64))
    Vectx=ch.chakra_obj_Float1D(c,dims=np.array([sizek],dtype=np.int64))
...
def test_syrk():
    ...
    #A matrix, C symetric matrix
     ...
     #generating random matrices and associated carma_obj
    matA=ch.chakra_obj_Float2D(c,dims=np.array([sizen,sizek],dtype=np.int64))
    matC=ch.chakra_obj_Float2D(c,dims=np.array([sizen,sizen],dtype=np.int64))
...
def test_syrkx():
    ...
    #A matrix, C symetric matrix
     ...
     #generating random matrices and associated carma_obj
    matA=ch.chakra_obj_Float2D(c,dims=np.array([sizen,sizek],dtype=np.int64))
    matB=ch.chakra_obj_Float2D(c,dims=np.array([sizen,sizek],dtype=np.int64))
    matC=ch.chakra_obj_Float2D(c,dims=np.array([sizen,sizen],dtype=np.int64))
