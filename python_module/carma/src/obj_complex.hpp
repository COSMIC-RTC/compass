...
struct CarmaObjComplexInterfacer
{
  ...
  static void call(py::module &mod)
  {
    ...
    py::class_<Class> carmaObj(mod, name.data(), py::buffer_protocol());
    carmaObj.def(
    ...
    carmaObj.def(py::init([](CarmaContext &c, const Class &data)
                              { return std::unique_ptr<Class>(new Class(&c, &data)); }),
                     "TODO", // TODO do the documentation...
                     py::arg("context").none(false),
                     py::arg("d_data").none(false));

    carmaObj.def_buffer([](Class &frame) -> py::buffer_info
                            {
      frame.sync_h_data();
    ...
    carmaObj.def("__repr__", &Class::to_string);

    // int32_t get_nb_streams()
    carmaObj.def_property_readonly("nb_streams", &Class::get_nb_streams,
                                       "TODO"); // TODO do the documentation...
    // int32_t add_stream()
    carmaObj.def("add_stream", (int32_t(Class::*)()) & Class::add_stream,
                     "TODO"); // TODO do the documentation...
    // int32_t add_stream(int32_t nb)
    carmaObj.def("add_stream", (int32_t(Class::*)(int32_t)) & Class::add_stream,
                     "TODO",
                     py::arg("np")); // TODO do the documentation...
    // int32_t del_stream()
    carmaObj.def("del_stream", (int32_t(Class::*)()) & Class::del_stream,
                     "TODO"); // TODO do the documentation...
    // int32_t del_stream(int32_t nb)
    carmaObj.def("del_stream", (int32_t(Class::*)(int32_t)) & Class::del_stream,
                     "TODO",
                     py::arg("np")); // TODO do the documentation...
    // int32_t wait_stream(int32_t stream)
    carmaObj.def("wait_stream", &Class::wait_stream, "TODO",
    ...
    carmaObj.def("wait_all_streams", &Class::wait_all_streams,
                     "TODO"); // TODO do the documentation...

    // const int64_t *get_dims()
    carmaObj.def_property_readonly(
        "shape",
    ...
    carmaObj.def_property_readonly("nbElem", &Class::get_nb_elements,
                                       "TODO"); // TODO do the documentation...
    // CarmaContext* get_context()
    carmaObj.def_property_readonly("context", &Class::get_context,
                                       "TODO"); // TODO do the documentation...
    // int32_t get_device()
    carmaObj.def_property_readonly("device", &Class::get_device,
                                       "TODO"); // TODO do the documentation...
    // int32_t get_o_data()
    // carmaObj.def_property_readonly("o_data", &Class::get_o_data_value,
    //                                    "TODO");  // TODO do the
    //                                    documentation...
    ...
    carmaObj.def("reset", (int32_t(Class::*)(void)) & Class::reset,
                     "TODO"); // TODO do the documentation...

    /**< sum */
    // T_data sum();
    // carmaObj.def("sum", &Class::sum,
    //                  "TODO");  // TODO do the documentation...
    // void init_reduceCub();
    carmaObj.def("init_reduceCub", &Class::init_reduceCub,
                     "TODO"); // TODO do the documentation...
    // void reduceCub();
    carmaObj.def("reduceCub", (void(Class::*)(void)) & Class::reduceCub,
                     "TODO"); // TODO do the documentation...
    ...
    carmaObj.def("aimax", &Class::aimax, "TODO",
                     py::arg("incx") = 1); // TODO do the documentation...
    // int32_t imin(int32_t incx);
    carmaObj.def("aimin", &Class::aimin, "TODO",
                     py::arg("incx") = 1); // TODO do the documentation...
    // T_data asum(int32_t incx);
    // carmaObj.def("asum", &Class::asum, "TODO",
    //                  py::arg("incx") = 1);  // TODO do the documentation...
    // T_data nrm2(int32_t incx);
    // carmaObj.def("nrm2", &Class::nrm2, "TODO",
    //                  py::arg("incx") = 1);  // TODO do the documentation...
    // T_data dot(CarmaObj<T_data> *source, int32_t incx, int32_t incy);
    // carmaObj.def("dot", &Class::dot, "TODO", py::arg("source").none(false),
    //                  py::arg("incx") = 1,
    //                  py::arg("incy") = 1);  // TODO do the documentation...
    // void scale(T_data alpha, int32_t incx);
    // carmaObj.def("scale", &Class::scale, "TODO",
    //                  py::arg("scale").none(false),
    //                  py::arg("incx") = 1);  // TODO do the documentation...
    // void swap(CarmaObj<T_data> *source, int32_t incx, int32_t incy);
    carmaObj.def("swap", &Class::swap, "TODO",
                     py::arg("source").none(false), py::arg("incx") = 1,
                     py::arg("incy") = 1); // TODO do the documentation...
    // void copy(CarmaObj<T_data> *source, int32_t incx, int32_t incy);
    carmaObj.def("copy", &Class::copy,
                     "TODO"); // TODO do the documentation...

    // /**< Curand */
    carmaObj.def("is_rng_init", &Class::is_rng_init);
    // int32_t init_prng();
    carmaObj.def("init_prng", (int32_t(Class::*)()) & Class::init_prng);
    // int32_t init_prng(int64_t seed);
    carmaObj.def("init_prng", (int32_t(Class::*)(int64_t)) & Class::init_prng);
    // int32_t destroy_prng();
    carmaObj.def("destroy_prng", &Class::destroy_prng);
    ...
    // carmaObj.def("prng", (int32_t (Class::*)(T *, char, float)) & Class::prng);
    ...
    carmaObj.def("prng", (int32_t(Class::*)(char, float)) & Class::prng);
    // int32_t prng(char gtype);
    carmaObj.def("prng", (int32_t(Class::*)(char)) & Class::prng);
