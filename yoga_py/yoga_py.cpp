...
static PyObject * YogaObj_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
  YogaObj *self;
  ...
  if (self != NULL) {
    ...
    self->yoga_object=(PyObject *)new yObjD( context_handle, (long *)dims_data, (double*)data_input,0);
    self->type=0;
    self->device = 0;
  }
...
static PyMemberDef YogaObj_members[] = {
  {"yoga_object", T_OBJECT_EX, offsetof(YogaObj, yoga_object), 0,
   "yoga_object name"},
...
static PyObject *YogaObj_name(YogaObj* self)
{
...
static PyMethodDef YogaObj_methods[] = {
  {"name", (PyCFunction)YogaObj_name, METH_NOARGS,
   "Return nothing"
  },
  {NULL}  /* Sentinel */
};
