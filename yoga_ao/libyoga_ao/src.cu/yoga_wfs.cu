...
int fillbinimg_async(yoga_host_obj<float> *image_telemetry, float *bimage, float *bcube, int npix, int nsub, int Nsub, int *ivalid, int *jvalid, int nim, bool add, int device)
{
...
int fillbinimg_async(yoga_streams *streams, yoga_obj<float> *bimage, yoga_obj<float> *bcube, int npix, int nsub, int Nsub, int *ivalid, int *jvalid, bool add, int device)
{
...
int fillbincube_async(yoga_streams *streams, float *bcube, cuFloatComplex *hrimage, int *indxpix, int Nfft, int Npix, int Nrebin, int Nsub, int device)
{
  int N = Npix * Nsub;
  int nthreads = 0,nblocks = 0;
  int nstreams = streams->get_nbStreams();
...
template void subap_reduce_async<float>(int threads, int blocks, yoga_streams *streams, float *d_idata, float *d_odata);
template void subap_reduce_async<double>(int threads, int blocks, yoga_streams *streams, double *d_idata, double *d_odata);
