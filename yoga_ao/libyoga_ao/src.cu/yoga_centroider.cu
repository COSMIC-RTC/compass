...
template void get_centroids_async<float>(int threads, int blocks, int n, yoga_streams *streams, float *d_idata, float *d_odata, float *alpha, float scale, float offset);
