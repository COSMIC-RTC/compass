...
class wfs:
   ...
   def on_drawingarea_control_map(self,wdg,*args):
      ...
      self.py2yo('wfs_win_init %d %d %d %d %d %d' % (mwid1,mwid2,mwid3,mwid4,mwid5,mwid6))

   def on_load_defaults_clicked(self):
      self.glade.get_widget('default_atm').set_active(0)
      self.glade.get_widget('default_wfs').set_active(0)
      self.glade.get_widget('default_dm').set_active(0)
      self.glade.get_widget('default_target').set_active(0)
      self.glade.get_widget('default_centro').set_active(0)
      self.glade.get_widget('default_control').set_active(0)
      self.glade.get_widget('device').set_value(1)
   ...
   def y_init_wfs(self,dummy):
      teldiam = self.glade.get_widget('teldiam').get_value()
      self.py2yo('create_wfs %d %d' % (1,teldiam))
   ...
   def on_start_wfs_clicked(self,wdg):
      wdg.set_sensitive(0)
      self.glade.get_widget('wfs_stop').set_sensitive(1)
      self.glade.get_widget('next').set_sensitive(0)
      self.glade.get_widget('unzoom_button').set_sensitive(0)
      self.glade.get_widget('initall').set_sensitive(0)
      self.py2yo('start_wfs_loop')

   def on_wfs_stop_clicked(self,wdg):
      wdg.set_sensitive(0)
      self.glade.get_widget('start_wfs').set_sensitive(1)
      self.glade.get_widget('initall').set_sensitive(1)
      self.glade.get_widget('next').set_sensitive(1)
      self.glade.get_widget('unzoom_button').set_sensitive(1)
      self.py2yo('pyk_set wfsloop %d' % 0)
      self.py2yo('animate %d' % 0)

   def on_initall_clicked(self,wdg):
      self.glade.get_widget('wfs_stop').set_sensitive(0)
      self.glade.get_widget('start_wfs').set_sensitive(1)
      self.glade.get_widget('initall').set_sensitive(1)
      self.glade.get_widget('next').set_sensitive(1)
      self.glade.get_widget('unzoom_button').set_sensitive(1)
   ...
   def on_next_clicked(self,wdg):
      self.py2yo('pyk_set wfsloop %d' % 1)
      self.py2yo('wfs_loop %d' % (1))
      self.py2yo('pyk_set wfsloop %d' % 0)
